...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, I18nManager, Linking, KeyboardAvoidingView, Pressable } from "react-native";
...
function Settings(props) {
	...
	const list = {
		name: "Moshe Ben Yosef",
		aid: "5465666",
		phone: "055465465",
		mail: "roy.g@018.co.il"
	}
	const [User, setuser] = React.useState(list);
